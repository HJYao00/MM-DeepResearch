...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def _handle_processing_tools_state(self, agent_data: AgentData) -> AgentState:
        ...
        for tool_call in agent_data.tool_calls[: self.max_parallel_calls]:
            tasks.append(self._call_tool(tool_call, agent_data.tools_kwargs, agent_data.image_data))
    ...
    async def _call_tool(
        self, tool_call: FunctionCall, tools_kwargs: dict[str, Any], image_data
        ...
        try:
            ...
            # print('agent_data.image_data', image_data)
            tool_execution_response, tool_reward, res = await tool.execute(instance_id, tool_args, **{"input_images": image_data[0]})
