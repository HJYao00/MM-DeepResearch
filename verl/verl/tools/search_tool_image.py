...
from verl.tools.utils.search_r1_like_utils_image import perform_single_search_batch
...
class SearchTool(BaseTool):
    ...
    async def create(self, instance_id: Optional[str] = None, **kwargs) -> tuple[str, ToolResponse]:
        ...
        """
        # print('kwargs', kwargs)
        #  kwargs {'create_kwargs': {'candidate_answers': '["Giorgio Grognet de Vasse", "Giorgio Grognet de Vass\\u00e9"]', 'data_source': 'searchR1_fvqa', 'ground_truth': {'target': ['Giorgio Grognet de Vassé']}, 'question': '<image>Who is the architect of this building?'}}
    ...
    def execute_search(self, instance_id: str, query_list: list, retrieval_service_url: str, topk: int, timeout: int):
        ...
        """
        result_image, result_text, metadata = perform_single_search_batch(
    ...
    async def execute(self, instance_id: str, parameters: dict[str, Any], **kwargs) -> tuple[ToolResponse, float, dict]:
        ...
        try:
            ...
            # print('266 result_image', result_image)
            # from verl.utils.dataset.vision_utils import process_image, process_video
            # processed_img = [process_image(Image.open(img)) for img in result_image[:1]]
            ...
            logger.debug(f"text query processed_img: {processed_img}")
